...
public class Warrior extends Player implements TypeReader {
	private AttributeGatherer _reader = new AttributeGatherer();
	
	public Warrior(String name, String type, Marker symbol, int character) {
	...
	public void setupAttributes(String type, int character) {
		if (type.equals("WARRIOR")) {
			String[] s = _reader.readFile("Warriors.txt", character);
			setValues(s);
		}
	}
